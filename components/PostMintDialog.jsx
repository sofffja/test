...
export default function PostMintDialog({ colorScheme, holderTxnLoadingStatus, holderTxnSuccessStatus, holderTxnHashLink  }) {
   ...
   const holderLocalTxnHash = holderTxnHashLink ? holderTxnHashLink.transactionHash : ""
   ...
   useEffect(() => {
      setHolderIsRendered(holderTxnSuccessStatus)
      openModal();
      console.log("runnning use effect")
      },
      [holderTxnSuccessStatus]
   )
         ...
         {holderTxnLoadingStatus == false && holderIsRendered == "success" ? (    
            <div className="flex flex-row justify-center"> 
               <button
                  ...
                  text-white text-center mt-10 w-fit sm:text-lg relative flex flex-row justify-items-center p-2 pl-3 bg-transparent border-2 border-solid  hover:text-white`}
               >
                  YOUR MINT INFO
               </button>
                        ...
                        <Dialog.Panel className="w-fit transform overflow-hidden bg-black align-middletransition-all shadow-[0_0px_30px_10px_rgba(0,0,0,1)]" >
                           <div className="border-white border-4 border-solid my-2 overflow-hidden rounded-none shadow-lg">
                              <div className="px-8 py-4">
                                 ...
                                 <div className="text-2xl mb-5">
                                    <Link href="/">
                                       <a className={` hover:text-red-500`} style={{ textDecoration: "underline" }}>
                                          See Your Collection ➝ 
                                       </a>
                                    </Link>
                                 </div>
                                    <button                                    
                                       ...
                                       px-4 py-2 text-xl text-white bg-black rounded-none borer-solid border-white border-4 hover:border-red-500 hover:text-red-500`} 
                                       onClick={() => {
                                       closeModal()                          
                                       }}
                                    >
